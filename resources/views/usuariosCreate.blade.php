        ...
        <div class="row mt-3">
            ...
            <form action="{{ route('usuarios.store') }}" method="post" id="formulario">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="apellido" id="apellido" class="form-control custom-input" required>
                  <small id="error-apellido" class="text-danger"></small>
                </div><br>
              
                <div class="form-group">
                  <label for="correo">Correo</label>
                  <input type="email" name="correo" id="correo" class="form-control custom-input" required>
                  <small id="error-correo" class="text-danger"></small>
                </div><br>
              
                <div class="form-group">
                  <label for="telefono">Telefono</label>
                  <input type="text" name="telefono" id="telefono" class="form-control custom-input" required>
                  <small id="error-telefono" class="text-danger"></small>
                </div><br>
              
                <div class="form-group">
                  <label for="direccion">Direccion</label>
                  <input type="text" name="direccion" id="direccion" class="form-control custom-input" required>
